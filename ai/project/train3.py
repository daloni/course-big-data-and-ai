...
from stable_baselines3.common.vec_env import DummyVecEnv, SubprocVecEnv, VecFrameStack, VecTransposeImage, VecNormalize
...
CHECKPOINT_FROM_PATH = "./ppo_carracing_20250520_2242.zip"
...
class GrayScaleObservation(ObservationWrapper):
    def __init__(self, env):
        super().__init__(env)
        self.observation_space = Box(low=0.0, high=1.0, shape=(48, 48, 1), dtype=np.float32)
